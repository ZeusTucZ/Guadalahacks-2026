...
export function Sidebar({ activeView, localActive, onNavigate, onNewRecording }: SidebarProps) {
  return (
    <aside className="hidden w-[260px] shrink-0 flex-col border-r border-zinc-800/80 bg-[#0c0c0e] px-5 py-6 lg:flex">
      <div className="mb-8">
        <h1 className="text-xl font-bold tracking-tight text-white">Lux</h1>
      ...
      {activeView === 'recordings' && onNewRecording && (
        <button
          type="button"
      ...
      <div
        className="mt-auto flex items-center gap-2 rounded-xl border border-zinc-800 bg-zinc-900/60 px-3 py-2.5 text-xs text-zinc-400 transition hover:text-zinc-200"
      >
